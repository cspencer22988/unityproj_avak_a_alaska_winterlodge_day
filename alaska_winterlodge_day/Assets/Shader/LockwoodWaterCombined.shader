Shader "Lockwood/WaterCombined" {
	Properties {
		...
		_WorldUVs ("WorldUVs", Range(0, 1)) = 1
		_ReflectionFlip ("ReflectionFlip", Range(-1, 1)) = -1
			...
			Program "vp" {
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  tmpvar_5.xy = worldSpaceVertex_2.xz;
					  highp vec2 tmpvar_6;
					  tmpvar_6 = mix (_glesMultiTexCoord0, tmpvar_5, vec4(_WorldUVs)).xy;
					  ...
					  xlv_TEXCOORD1 = ((tileableUv_1.xyxy + (_Time.xxxx * _BumpDirection)) * _BumpTiling);
					}
					...
					uniform highp float _ReflectionFlip;
					...
					void main ()
					{
					  ...
					  reflectVector_1.x = (tmpvar_10.x * _ReflectionFlip);
					  lowp vec4 tmpvar_11;
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "LKWD_LIGHTMAP_ON" "SPECULAR_ON" }
					"!!GLES
					#version 100
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  xlv_TEXCOORD0 = tmpvar_3;
					  xlv_TEXCOORD1 = ((tileableUv_1.xyxy + (_Time.xxxx * _BumpDirection)) * _BumpTiling);
					  xlv_TEXCOORD2 = ((tmpvar_7.z * unity_FogParams.z) + unity_FogParams.w);
					}
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "FOG_LINEAR" "LKWD_LIGHTMAP_ON" "SPECULAR_ON" }
					"!!GLES
					#version 100
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  xlv_TEXCOORD0 = tmpvar_3;
					  xlv_TEXCOORD1 = ((tileableUv_1.xyxy + (_Time.xxxx * _BumpDirection)) * _BumpTiling);
					  xlv_TEXCOORD2 = exp2(-((unity_FogParams.y * tmpvar_7.z)));
					}
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "FOG_EXP" "LKWD_LIGHTMAP_ON" "SPECULAR_ON" }
					"!!GLES
					#version 100
					...
					void main ()
					{
					  ...
					  xlv_TEXCOORD1 = ((tileableUv_1.xyxy + (_Time.xxxx * _BumpDirection)) * _BumpTiling);
					  xlv_TEXCOORD2 = ((_glesMultiTexCoord1.xy * unity_LightmapST.xy) + unity_LightmapST.zw);
					  xlv_TEXCOORD3 = exp2(-((unity_FogParams.y * tmpvar_7.z)));
					}
				...
				SubProgram "gles hw_tier00 " {
					...
					void main ()
					{
					  ...
					  tmpvar_9 = (unity_FogParams.x * tmpvar_7.z);
					  gl_Position = tmpvar_7;
					  xlv_TEXCOORD0 = tmpvar_3;
					  xlv_TEXCOORD1 = ((tileableUv_1.xyxy + (_Time.xxxx * _BumpDirection)) * _BumpTiling);
					  xlv_TEXCOORD2 = exp2((-(tmpvar_9) * tmpvar_9));
					}
				...
				SubProgram "gles hw_tier00 " {
					Keywords { "FOG_EXP2" "LKWD_LIGHTMAP_ON" "SPECULAR_ON" }
					"!!GLES
					#version 100
					...
					void main ()
					{
					  ...
					  xlv_TEXCOORD1 = ((tileableUv_1.xyxy + (_Time.xxxx * _BumpDirection)) * _BumpTiling);
					  xlv_TEXCOORD2 = ((_glesMultiTexCoord1.xy * unity_LightmapST.xy) + unity_LightmapST.zw);
					  xlv_TEXCOORD3 = exp2((-(tmpvar_9) * tmpvar_9));
					}
